...
export default function LocationCombobox({
  ...
  return (
    <div ref={rootRef} className={`relative ${className ?? ''}`}>
      ...
      {showDropdown ? (
        <div
          className="absolute left-0 top-[calc(100%+10px)] z-[100] w-full min-w-[320px] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl md:w-[420px]"
        >
