...
const DEPARTMENT_USERS: Array<{
  role: UserRole
  fullName: string
  email: string
}> = [
  { role: 'finance', fullName: 'Finance User', email: 'finance@destinationzm.local' },
  { role: 'reservations', fullName: 'Reservations User', email: 'reservations@destinationzm.local' },
  { role: 'operations', fullName: 'Operations User', email: 'operations@destinationzm.local' },
  { role: 'recovery', fullName: 'Recovery User', email: 'recovery@destinationzm.local' },
  { role: 'management', fullName: 'Management User', email: 'management@destinationzm.local' },
  { role: 'executive', fullName: 'Executive User', email: 'executive@destinationzm.local' },
]
